...
//							"Ion Canto", "Gabriel Rivero", "Rachida Mesa", "Lídia Ferreiro",
...
//							"Teodora Sole", "Alícia Davila", "Isidoro Prat", "Dina Neira",
//							"Alan Bello", "Emiliana Mejias", "Aaron Vilchez", "Valentina Peral",
//							"Juan-Carlos Sánchez", "Olga Gil"};
		...
		String[] alumnos = {"Eduard MelgarI", "Maria-Paz PiquerasP", "Saul GuisadoI", "Maria-Josefa EspinosaP",
				...
				"Ion CantoP", "Gabriel RiveroI", "Rachida MesaP", "Lídia FerreiroI",
				...
				"Teodora SoleP", "Alícia DavilaI", "Isidoro PratP", "Dina NeiraI",
				"Alan BelloP", "Emiliana MejiasI", "Aaron VilchezP", "Valentina PeralI",
				"Juan-Carlos SánchezP", "Olga GilI"};
